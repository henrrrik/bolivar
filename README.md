...
Bolivar receives Garmin inReach satellite text messages through [46elks](https://46elks.se), plots them on a map from [Mapbox](https://www.mapbox.com), and optionally forwards them to a [Telegram](https://telegram.org) group with a map pin.
